...
SELECT 
        ...
        CAST(v*1000 AS FLOAT)	AS trade_value_current_usd,
...
WHERE   ce.country IN ('Argentina', 'Brazil', 'Bolivia', 'Chile', 'Colombia', 'Ecuador', 'Paraguay', 'Peru', 'Uruguay', 'Venezuela')
        OR ci.country IN ('Argentina', 'Brazil', 'Bolivia', 'Chile', 'Colombia', 'Ecuador', 'Paraguay', 'Peru', 'Uruguay', 'Venezuela')
);